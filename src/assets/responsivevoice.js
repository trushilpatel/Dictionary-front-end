...
Array.from || (Array.from = function() {
    var t = Object.prototype.toString,
        r = function(q) {
            return "function" === typeof q || "[object Function]" === t.call(q)
        },
        u = Math.pow(2, 53) - 1;
    return function(q) {
        var a = Object(q);
        ...
        var l = 1 < arguments.length ? arguments[1] : void 0,
            p;
        if ("undefined" !== typeof l) {
            if (!r(l))
                throw new TypeError("Array.from: when provided, the second argument must be a function");
            2 < arguments.length && (p = arguments[2])
        }
        var b = Number(a.length);
        b = isNaN(b) ? 0 : 0 !== b && isFinite(b) ? (0 < b ? 1 : -1) * Math.floor(Math.abs(b)) : b;
        b = Math.min(Math.max(b, 0), u);
        for (var c = r(this) ? Object(new this(b)) : Array(b), d = 0, e; d < b;)
            e = a[d],
            c[d] = l ? "undefined" === typeof p ? l(e, d) : l.call(p, e, d) : e,
            d += 1;
        c.length = b;
        return c
    }
    ...
    var ResponsiveVoice = function() {
                ...
                try {
                    for (var e = 0; e < l.length; e++) {
                        ...
                        g ? (Array.isArray(g) || (g = [g]),
                            c.collectionvoice && c.collectionvoice.name && -1 != g.indexOf(c.collectionvoice.name) && (f = !0)) : f = !0;
                        var n = !1,
                            k = h.systemvoices;
                        k ? (Array.isArray(k) || (k = [k]),
                            c.systemvoice && c.systemvoice.name && -1 != k.indexOf(c.systemvoice.name) && (n = !0)) : n = !0;
                    ...
                    if (a[c].src && p.test(a[c].src)) {
                        ...
                        if (e.search) {
                            ...
                            for (d = 0; d < f.length; d++)
                                e = f[d].split("="),
                                h[e[0]] = e[1];
                            h = h.source ? h.source : !1
                        } else
                            h = !1;
                        if (h && "wp-plugin" == h)
                            return p.lastIndex = 0, !0
                    }
                return !1
            }
                ...
                if (null == b)
                    ...
                    if (a.isPlaying())
                        ...
                        if (null == c) {
                            ...
                            f = a.getResponsiveVoice(c);
                        !0 === f.deprecated && console.warn("ResponsiveVoice: Voice " + f.name + " is deprecated and will be removed in future releases");
                        var g = {};
                        if (null != f.mappedProfile)
                            g = f.mappedProfile;
                        ...
                        if (b.length > a.CHARACTER_LIMIT) {
                            for (var k = b = t(b); k.length > a.CHARACTER_LIMIT;) {
                                f = k.search(/([\u3002:!\u00a1?\u00bf;\(\)\[\]\u2014\u00ab\u00bb\n]+|\.[^0-9]+)/);
                                var m = "";
                                if (-1 == f || f >= a.CHARACTER_LIMIT)
                                    f = k.search(/,[^0-9]+/);
                                if ((-1 == f || f >= a.CHARACTER_LIMIT) && -1 != k.search(" ")) {
                                    var l = k.split(" ");
                                    for (f = 0; f < l.length; f++) {
                                        if (m.length + l[f].length + 1 > a.CHARACTER_LIMIT) {
                                            l[f].length >= a.CHARACTER_LIMIT && (m += l[f].substr(0, a.CHARACTER_LIMIT - m.length - 1));
                                            break
                                        }
                                        m += (0 != f ? " " : "") + l[f]
                                    }
                                ...
                                k = k.substr(m.length, k.length - m.length);
                                n.push(m)
                            }
                            0 < k.length && e(k)
                        } else
                        ...
                        if (a.checkSpeechAllowed()) {
                            ...
                            for (f = 0; f < n.length; f++)
                                if (!a.fallbackMode && a.getServiceEnabled(a.services.NATIVE_TTS))
                                    ...
                                    e.voiceURI = g.systemvoice.voiceURI,
                                    e.volume = a.selectBest([g.collectionvoice.volume, g.systemvoice.volume, 1]),
                                    e.rate = a.selectBest([a.iOS9plus ? 1 : null, g.collectionvoice.rate, g.systemvoice.rate, 1]),
                                    e.pitch = a.selectBest([g.collectionvoice.pitch, g.systemvoice.pitch, 1]),
                                    e.text = n[f],
                                    e.lang = a.selectBest([g.collectionvoice.lang, g.systemvoice.lang]),
                                    e.rvIndex = f,
                                    e.rvTotal = n.length,
                                    0 == f && (e.onstart = a.speech_onstart),
                                    a.msgparameters.onendcalled = !1,
                                    null != d ? (e.voice = "undefined" !== typeof d.voice ? d.voice : g.systemvoice,
                                        f < n.length - 1 && 1 < n.length ? (e.onend = a.onPartEnd,
                                ...
                                e = a.selectBest([g.collectionvoice.pitch, g.systemvoice.pitch, 1]);
                                k = a.selectBest([a.iOS9plus ? 1 : null, g.collectionvoice.rate, g.systemvoice.rate, 1]);
                                m = a.selectBest([g.collectionvoice.volume, g.systemvoice.volume, 1]);
                                if (null != d) {
                                ...
                                l = "?t=" + encodeURIComponent(n[f]) + "&tl=" + (g.collectionvoice.lang || g.systemvoice.lang || "en-US") + "&sv=" + (g.collectionvoice.service || g.systemvoice.service || "") + "&vn=" + (g.collectionvoice.voicename || g.systemvoice.voicename || "") + "&pitch=" + e.toString() + "&rate=" + k.toString() + "&vol=" + m.toString();
                                "undefined" != typeof rvApiEndpoint && rvApiEndpoint && (l = "?text=" + encodeURIComponent(n[f]) + "&lang=" + (g.collectionvoice.lang || g.systemvoice.lang || "en-US") + "&engine=" + (g.collectionvoice.service || g.systemvoice.service || "") + "&name=" + (g.collectionvoice.voicename || g.systemvoice.voicename || "") + "&pitch=" + e.toString() + "&rate=" + k.toString() + "&volume=" + m.toString());
                                e = a.fallbackServicePath + l;
                                ...
                                void 0 !== g.collectionvoice.gender && (e += "&gender=" + g.collectionvoice.gender);
            ...
            a.mapRVs = function() {
                ...
                for (c = 0; c < a.responsivevoices.length; c++) {
                    ...
                    for (var e = 0; e < d.voiceIDs.length; e++) {
                        var h = a.voicecollection[d.voiceIDs[e]];
            ...
            a.Dispatch = function(b) {
                ...
                var e = b + "_callbacks_timeout",
                    h = b + "_callbacks_timeoutCount";
                a.hasOwnProperty(e) || (a[h] = 10,
                    a[e] = setInterval(function() {
                        --a[h];
                        (a.Dispatch(b) || 0 > a[h]) && clearTimeout(a[e])
                    }, 50));
                return !1
            };
            ...
            a.numToWords = function(b) {
                ...
                return "number" === typeof b ? a.numToWords(String(b)) : "0" === b ? "zero" : l(m(3))(g)(Array.from(b)).map(t).map(u).filter(l(k)(e)).reverse().join(" ").trim()
            };
            ...
            a.getEstimatedTimeLength = function(b, c) {
                b = a.getWords(b);
                var d = 0,
                    e = a.fallbackMode ? 1300 : 700;
                c = c || 1;
                b.map(function(a, b) {
                    d += (a.toString().match(/[^ ]/igm) || a).length
                });
                var h = b.length,
                    f = 60 / a.WORDS_PER_MINUTE * c * 1E3 * h;
                5 > h && (f = c * (e + 50 * d));
                a.log("Estimated time length: " + f + " ms, words: [" + b + "], charsCount: " + d);
                return f
            };
            ...
            var p = /(code\.responsivevoice\.org|local-lb).*?responsivevoice(\.\w+)?\.js/ig;
